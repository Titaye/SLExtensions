// <copyright file="HybridView.cs" company="Ucaya">
...
namespace SLExtensions.Controls.Layers.VirtualEarth
{
    ...
    /// Hybrid map view
    /// </summary>
    public class HybridView : VETileSource
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HybridView"/> class.
        /// </summary>
        public HybridView()
        {
            DefaultStyleKey = typeof(HybridView);
        }
        ...
        public override Uri GetTileImageUrl(Point tileXY, uint leveOfDetail)
        {
            ...
            return new Uri(string.Format("http://{0}{3}.ortho.tiles.virtualearth.net/tiles/{0}{1}{2}", "h", TileXYToQuadKey(tileXY, leveOfDetail), ".png?g=131&shading=hill", srv));
