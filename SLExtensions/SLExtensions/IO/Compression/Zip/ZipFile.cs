...
using SLExtensions.IO.Compression.Zip.Encryption;
...
namespace SLExtensions.IO.Compression.Zip
{
    ...
    using SLExtensions.IO.Compression.Zip.Checksums;
    using SLExtensions.IO.Compression.Zip.Core;
    using SLExtensions.IO.Compression.Zip.ZipCompression;
    using SLExtensions.IO.Compression.Zip.ZipCompression.Streams;
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        /// </exception>
        /// <exception cref="SLExtensions.IO.Compression.Zip.ZipException">
