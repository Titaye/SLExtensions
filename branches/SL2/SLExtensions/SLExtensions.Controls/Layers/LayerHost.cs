...
namespace SLExtensions.Controls.Layers
{
    ...
    public class LayerHost : Control, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initializes static behavior of the <see cref="LayerHost"/> class.
        /// </summary>
        static LayerHost()
        {
            LayerHostMouseWheelHelper.Initialize();
        }
        ...
        /// <summary>
        /// Layer host mouse wheel helper
        /// </summary>
        private static class LayerHostMouseWheelHelper
        {
            #region Fields
            ...
            /// <summary>
            /// Hook mouse wheel to this type
            /// </summary>
            public static void Initialize()
            {
                if (!LayerHostMouseWheelHelper.initialized)
                {
                    MouseWheelGenerator.MouseWheelEvent.RegisterClassHandler(typeof(LayerHost), LayerHostMouseWheelHelper.HandleMouseWheel, false);
                    LayerHostMouseWheelHelper.initialized = true;
                }
            }
            ...
            {
                LayerHost sv = (LayerHost)sender;
                sv.HandleMouseWheel(e);
            }
