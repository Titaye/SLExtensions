...
namespace SLExtensions.Data
{
    ...
    public class VisibilityConverter : BoolConverter
    {
        ...
        public override object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (prm != null)
            {
                bool prmResult = (bool)base.Convert(value, targetType, parameter, culture);

                // If a VisibilityConverterParameter is provided, handle the convertion from its properties values
                Visibility trueValue = prm.ConvertionType == VisibilityConvertionType.IfValueVisible ? Visibility.Visible : Visibility.Collapsed;
                Visibility falseValue = prm.ConvertionType == VisibilityConvertionType.IfValueVisible ? Visibility.Collapsed : Visibility.Visible;
