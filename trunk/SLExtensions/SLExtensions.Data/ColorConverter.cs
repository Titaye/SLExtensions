namespace SLExtensions.Data
{
    ...
    public class ColorConverter : IValueConverter
    {
        ...
        {
            return (Color)new ColorConverter().Convert(value, typeof(Color), null, CultureInfo.CurrentCulture);
        }
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            {
                Match m = ColorRegex.Match(strValue);
                if (m.Success)
                {
                    byte a = 255;
                ...
                {
                    Color cachedColor;
                    if (colorCache.TryGetValue(strValue, out cachedColor))
                    {
                        return cachedColor;
                    }
                    ...
                    var colorProperty = typeof(Colors).GetProperty(strValue, System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.IgnoreCase);
                    ...
                    if (color == null)
                    {
                        colorProperty = typeof(ColorConverter).GetProperty(strValue, System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.IgnoreCase);
                        if (colorProperty != null && colorProperty.PropertyType == typeof(Color))
                        {
                            color = (Color)colorProperty.GetValue(null, null);
                        }
                    ...
                    if (color != null)
                    {
                        colorCache[strValue] = color.Value;
                        return color;
                    }
                }
            }
