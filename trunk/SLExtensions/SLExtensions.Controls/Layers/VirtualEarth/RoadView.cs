...
namespace SLExtensions.Controls.Layers.VirtualEarth
{
    ...
    /// Road map view
    /// </summary>
    public class RoadView : VETileSource
    {
        #region Fields
        ...
        public override Uri GetTileImageUrl(Point tileXY, uint leveOfDetail)
        {
            ...
            return new Uri(string.Format("http://{0}{3}.ortho.tiles.virtualearth.net/tiles/{0}{1}{2}", "r", TileXYToQuadKey(tileXY, leveOfDetail), ".png?g=131&shading=hill", srv));
